...
from data_base.class_comands import LowPrice
from commands.loader import bot, history


def get_city_name_for_lowprice(message):
    """ Получаем запрос города, инициализируем запрос к базе, ищем отели с низкими ценами """
